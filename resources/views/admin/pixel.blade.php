        ...
        <div class="bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-white">
                ...
                <form method="POST" action="{{ route('tag.store') }}">
                    @csrf
                    <div class="mb-4">
                        <label for="name" class="block text-sm font-medium text-gray-300">Nome da Tag</label>
                        <input type="text" name="name" id="name" class="mt-1 block w-full bg-gray-800 border-gray-600 text-gray-300 focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm rounded-md" required>
                    </div>
                    <div class="mb-4">
                        <label for="tag_id" class="block text-sm font-medium text-gray-300">ID da Tag</label>
                        <input type="text" name="tag_id" id="tag_id" class="mt-1 block w-full bg-gray-800 border-gray-600 text-gray-300 focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm rounded-md" required>
                    </div>
                    <div class="mb-4">
                        <label for="tag_token" class="block text-sm font-medium text-gray-300">Token da Tag</label>
                        <input type="text" name="tag_token" id="tag_token" class="mt-1 block w-full bg-gray-800 border-gray-600 text-gray-300 focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm rounded-md" required>
                    </div>
                    <div class="flex justify-end">
                        <button type="submit" class="bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-2 px-4 rounded transition duration-300">Salvar</button>
                    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-gray-800 rounded-lg">
                        <thead>
                            <tr>
                                <th class="px-4 py-2 text-left text-gray-300">Nome da Tag</th>
                                <th class="px-4 py-2 text-left text-gray-300">ID da Tag</th>
                                <th class="px-4 py-2 text-left text-gray-300">Token da Tag</th>
                                <th class="px-4 py-2 text-left text-gray-300">Ações</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="px-4 py-2 text-center text-gray-500">Nenhuma Tag criada ainda.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
